            ...
            <div class="col-xs-8 offset-2">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-3">
                                <a href="{{ url('/supplierRegister') }}" class="btn btn-outline-info">
                                    Customer register
                                </a>
                            </div>
                            <div class="col-6">
                                <h3 style="font-family:  'Adobe Caslon Pro Bold'; font-weight: 900;color: #0f7864">Customer Registration</h3>
                            </div>
                            <div class="col-3"></div>
